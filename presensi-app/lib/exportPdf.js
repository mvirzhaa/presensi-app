...
const COLUMNS = [
  ...
  { key: 'nama',     label: 'Nama',            width: 80  },
  { key: 'instansi', label: 'Instansi',        width: 80  },
  { key: 'jabatan',  label: 'Jabatan',         width: 65  },
  { key: 'waktu',    label: 'Waktu Hadir',     width: 72  },
  { key: 'lokasi',   label: 'Lokasi',          width: 60  },
  { key: 'catatan',  label: 'Kesan & Catatan', width: 83  },
  { key: 'ttd',      label: 'Tanda Tangan',    width: 53  },
];

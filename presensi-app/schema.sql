...
CREATE TABLE IF NOT EXISTS participants (
  ...
  catatan       TEXT NULL,                   -- kesan / catatan yang dituliskan tamu (opsional)
...
--
-- Jika database belum memiliki kolom catatan pada tabel participants
-- (kesan/catatan tamu), jalankan migrasi berikut:
--
--   ALTER TABLE participants ADD COLUMN catatan TEXT NULL;
--
